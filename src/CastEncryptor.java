...
public class CastEncryptor {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        CastEncryptor.encoding("01 23 45 67 89 AB CD EF", "01 23 45 67 12 34 56 78 23 45 67 89 34 56 78 9A");
    }
    ...
    private static byte[] hexStringToByteArray(String hexString) {
        ...
        byte[] bytekey = new byte[hexes.length];
        for (int i = 0; i < hexes.length; i++) {
            bytekey[i] = (byte) ((Character.digit(hexes[i].charAt(0), 16) << 4)
                    + Character.digit(hexes[i].charAt(1), 16));
        }
        return bytekey;
    }
    ...
    //Алгоритм шифрования
    public static int[] encoding(String hexText, String keyHex) throws UnsupportedEncodingException {
        ...
        byte[] temp2 = hexStringToByteArray(hexText);
